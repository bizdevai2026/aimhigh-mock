...
export { hashPin } from "./auth/pin.js?v=20260525";
...
export {
  ...
  startDemoSession,
  signOut
} from "./auth/session.js?v=20260525";
...
export {
  ...
  profileName,
  signedInName
} from "./auth/profile.js?v=20260525";

export { requireSignInOrRedirect } from "./auth/gate.js?v=20260525";

// Backward-compat shims — older code calls these names.
export { requireSignInOrRedirect as requireProfileOrRedirect } from "./auth/gate.js?v=20260525";
export { signOut as clearProfile } from "./auth/session.js?v=20260525";
