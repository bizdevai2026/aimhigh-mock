...
import "./mock.js?v=20260606"; // shared header (sound toggle, profile chip)
import {
  loadAllQuestions,
...
import { playLevelUp, playPerfect, playModeStartSprint, playModeStartWarmup, makeListenButton, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticStreak, hapticPerfect } from "./sounds.js?v=20260606";
