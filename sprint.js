...
import "./mock.js?v=20260612"; // shared header (sound toggle, profile chip)
import {
  loadAllQuestions,
...
import { playLevelUp, playPerfect, playModeStartSprint, playModeStartWarmup, makeListenButton, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticStreak, hapticPerfect } from "./sounds.js?v=20260612";
...
import { subjectTone, prettyTopic } from "./shared/subjects.js?v=20260612";
