...
import "./mock.js?v=20260506"; // shared header (sound toggle, profile chip)
import {
  loadAllQuestions,
  ...
  topicsForSubject,
  topicCounts
} from "./questions.js?v=20260506";
import {
  noteSessionResult,
  readStreak,
  topicLadder,
  subjectLadder
} from "./engagement.js?v=20260506";
import { playCorrect, playWrong, playLevelUp, playStreak3, playStreak5, playPerfect, playModeStartSprint, playModeStartWarmup, makeListenButton, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticCorrect, hapticWrong, hapticStreak, hapticPerfect } from "./sounds.js?v=20260506";
