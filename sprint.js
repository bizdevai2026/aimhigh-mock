...
import "./mock.js?v=20260601"; // shared header (sound toggle, profile chip)
import {
  loadAllQuestions,
  ...
  topicsForSubject,
  topicCounts
} from "./questions.js?v=20260601";
import {
  noteSessionResult,
  readStreak,
  topicLadder,
  subjectLadder
} from "./engagement.js?v=20260601";
...
import { playLevelUp, playPerfect, playModeStartSprint, playModeStartWarmup, makeListenButton, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticStreak, hapticPerfect } from "./sounds.js?v=20260601";
