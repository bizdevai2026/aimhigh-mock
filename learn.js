...
import "./mock.js?v=20260605"; // shared header behaviour
import { listSubjects, subjectName, topicsForSubject, loadAllQuestions } from "./questions.js?v=20260605";
import { topicLadder, weakTopics } from "./engagement.js?v=20260605";
import { getVisual } from "./visuals.js?v=20260605";
import { validateLearning, reportProblems } from "./diagnostics/schema-validator.js?v=20260605";
import { escapeHtml, match } from "./shared/dom.js?v=20260605";
import { subjectTone, prettyTopic } from "./shared/subjects.js?v=20260605";
import { readString, writeString } from "./platform/storage.js?v=20260605";
