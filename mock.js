...
import {
  ...
  weakTopics,
  isPaused
} from "./engagement.js?v=20260607";

import { readSoundOn, toggleSound } from "./sounds.js?v=20260607";
import { profileName, requireProfileOrRedirect, clearProfile, isParentRole, isChildRole, isDemoRole, signedInRole } from "./profile.js?v=20260607";
import { todaysSubjects, dayName, isSchoolDay } from "./timetable.js?v=20260607";
import { readString as storageReadString, writeString as storageWriteString } from "./platform/storage.js?v=20260607";
...
if (/[?&]diag=1\b/.test(location.search)) {
  import("./diagnostics/panel.js?v=20260607").catch(function (e) {
