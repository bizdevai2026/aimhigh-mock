...
import { readSoundOn, toggleSound } from "./sounds.js?v=20260605";
import { profileName, requireProfileOrRedirect, clearProfile, isParentRole, isChildRole, isDemoRole, signedInRole } from "./profile.js?v=20260605";
import { todaysSubjects, dayName, isSchoolDay } from "./timetable.js?v=20260605";
import { readString as storageReadString, writeString as storageWriteString } from "./platform/storage.js?v=20260605";
...
if (/[?&]diag=1\b/.test(location.search)) {
  import("./diagnostics/panel.js?v=20260605").catch(function (e) {
