...
import "./mock.js?v=20260516"; // shared header behaviour (sound toggle, streak chip)
import { loadAllQuestions, pickWarmupQuestions, subjectName } from "./questions.js?v=20260516";
import { noteSessionResult, readStreak, readXpToday } from "./engagement.js?v=20260516";
import { playCorrect, playWrong, playLevelUp, playStreak3, playStreak5, playPerfect, playTap, playModeStartWarmup, makeListenButton, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticCorrect, hapticWrong, hapticStreak, hapticPerfect } from "./sounds.js?v=20260516";
