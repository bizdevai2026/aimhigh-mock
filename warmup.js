...
import "./mock.js?v=20260519"; // shared header behaviour (sound toggle, streak chip)
import { loadAllQuestions, pickWarmupQuestions, subjectName } from "./questions.js?v=20260519";
import { noteSessionResult, readStreak, readXpToday } from "./engagement.js?v=20260519";
import { playCorrect, playWrong, playLevelUp, playStreak3, playStreak5, playPerfect, playTap, playModeStartWarmup, makeListenButton, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticCorrect, hapticWrong, hapticStreak, hapticPerfect } from "./sounds.js?v=20260519";
import { getVisual } from "./visuals.js?v=20260519";
import { isParentRole } from "./profile.js?v=20260519";
import { readJson as storageReadJson, writeJson as storageWriteJson, remove as storageRemove } from "./platform/storage.js?v=20260519";
