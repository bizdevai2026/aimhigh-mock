...
import "./mock.js?v=20260528"; // shared header behaviour (sound toggle, streak chip)
import { loadAllQuestions, pickWarmupQuestions } from "./questions.js?v=20260528";
import { noteSessionResult, readStreak, readXpToday } from "./engagement.js?v=20260528";
...
import { playLevelUp, playPerfect, playTap, playModeStartWarmup, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticStreak, hapticPerfect } from "./sounds.js?v=20260528";
...
import { subjectColor } from "./shared/subjects.js?v=20260528";
import { onAnswerCorrect, onAnswerWrong } from "./practice/feedback.js?v=20260528";
import { renderQuestionCard, subjectLabel } from "./practice/render.js?v=20260528";
