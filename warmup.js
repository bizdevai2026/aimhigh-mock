...
import "./mock.js?v=20260531"; // shared header behaviour (sound toggle, streak chip)
import { loadAllQuestions, pickWarmupQuestions } from "./questions.js?v=20260531";
import { noteSessionResult, readStreak, readXpToday } from "./engagement.js?v=20260531";
...
import { playLevelUp, playPerfect, playTap, playModeStartWarmup, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticStreak, hapticPerfect } from "./sounds.js?v=20260531";
import { isParentRole } from "./profile.js?v=20260531";
import { readJson as storageReadJson, writeJson as storageWriteJson, remove as storageRemove } from "./platform/storage.js?v=20260531";
import { escapeHtml } from "./shared/dom.js?v=20260531";
import { subjectColor } from "./shared/subjects.js?v=20260531";
import { onAnswerCorrect, onAnswerWrong } from "./practice/feedback.js?v=20260531";
import { renderQuestionCard, subjectLabel } from "./practice/render.js?v=20260531";
