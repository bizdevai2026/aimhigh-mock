...
import "./mock.js?v=20260605"; // shared header behaviour (sound toggle, streak chip)
import { loadAllQuestions, pickWarmupQuestions } from "./questions.js?v=20260605";
import { noteSessionResult, readStreak, readXpToday } from "./engagement.js?v=20260605";
...
import { playLevelUp, playPerfect, playTap, playModeStartWarmup, frenchSpellMatches, speechRecognitionAvailable, recordFrench, frenchSpeechMatches, hapticStreak, hapticPerfect } from "./sounds.js?v=20260605";
...
import { escapeHtml } from "./shared/dom.js?v=20260605";
import { subjectColor } from "./shared/subjects.js?v=20260605";
